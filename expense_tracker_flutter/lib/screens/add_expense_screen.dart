...
class _AddExpenseScreenState extends State<AddExpenseScreen> {
  ...
  String _currentTab = 'expense'; // expense, income, transfer
  ...
  Widget _buildCategoryGrid() {
    final categories = _currentTab == 'expense' ? _expenseCategories : _incomeCategories;
  ...
  Future<void> _saveTransaction() async {
    ...
    print('DEBUG: Saving ${_currentTab} - Amount: $amount, Category: $_selectedCategory, Date: $_selectedDate');
    ...
    try {
      ...
      if (mounted) {
        ...
        ScaffoldMessenger.of(context).showSnackBar(
          SnackBar(content: Text('${_currentTab == 'expense' ? 'Expense' : 'Income'} added successfully!')),
        );
      }
    } catch (e) {
